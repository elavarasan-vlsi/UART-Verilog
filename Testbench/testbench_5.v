...
// testing baud rate mismatch about 5% with Tx at 10000 bps and Rx at 9600 bps
// result at Waveforms/testbench_5bm
...
module test_bench ();
    ...
    reg [12:0] Tx_baud_rate = 13'h1388; // => 1 / (baud rate x clock period)
    ...
    initial begin    // 5% TOLERANCE AT 13'h1388
        ...
        #1000000 Data_In = 8'h00;
        #1000000 Data_In = 8'hFF;
        #1000000 Data_In = 8'hAA;
        #1000000 Data_In = 8'hAF; enable_Tx = 0;
